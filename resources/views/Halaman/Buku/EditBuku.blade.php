  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
              <div class="box-body">
                <form role="form" method="post" action="{{ url('buku/'.$dt->id) }}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="penerbit" value="{{ $dt->penerbit }}" class="form-control" id="exampleInputEmail1" placeholder="Penerbit Buku">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Tahun Terbit</label>
                        <input type="date" name="tahun_terbit" value="{{ $dt->tahun_terbit }}" class="form-control" id="exampleInputEmail1" placeholder="Tahun Terbit">
                      </div>
                      <div class="form-group">
